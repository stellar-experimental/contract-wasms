(module
  ...
  (export "ping" (func 76))
  (export "renounce_ownership" (func 77))
  (export "royalty_info" (func 78))
  (export "set_image" (func 79))
  (export "set_royalty_recipient" (func 80))
  ...
  (func (;92;) (type 19) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      block ;; label = @2
        local.get 3
  ...
  (func (;95;) (type 18) (param i32 i64 i64 i64 i64)
