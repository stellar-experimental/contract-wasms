(module
  ...
  (export "sync_balance" (func 53))
  (export "withdraw" (func 55))
  (export "get_balance" (func 56))
  (export "get_all_balances" (func 57))
