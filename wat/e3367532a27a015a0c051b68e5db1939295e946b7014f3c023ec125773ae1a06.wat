(module
  ...
  (global (;2;) i32 i32.const 1048941)
  ...
  (func (;20;) (type 8) (param i32 i32 i64 i32 i32)
    local.get 0
    local.get 0
    local.get 1
    call 22
  ...
  (func (;31;) (type 10) (param i32 i32 i32 i64 i64)
  ...
  (func (;32;) (type 11) (param i32 i32 i64 i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;37;) (type 11) (param i32 i32 i64 i64)
    local.get 0
    i32.const 0
    local.get 1
    local.get 2
