(module
  ...
  (global (;2;) i32 i32.const 1049964)
  ...
  (func (;53;) (type 22) (param i64 i32) (result i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;63;) (type 24) (param i64 i32 i32)
    local.get 0
    i64.const 4
    local.get 1
    i64.extend_i32_u
  ...
  (func (;65;) (type 25) (param i64 i64 i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;68;) (type 12) (param i64 i32 i32) (result i64)
    local.get 0
    i64.const 4
    local.get 1
    i64.extend_i32_u
