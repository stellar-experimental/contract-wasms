(module
  ...
  (export "capture" (func 30))
  (export "get_admin" (func 31))
  (export "get_range" (func 32))
  (export "message" (func 34))
  ...
  (func (;40;) (type 15) (param i32 i64 i64 i64 i64 i32)
  ...
  (func (;45;) (type 16) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
