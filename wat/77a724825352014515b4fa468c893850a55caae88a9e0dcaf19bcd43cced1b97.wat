(module $flash_arb_executor.wasm
  ...
  (import "x" "7" (func $_ZN17soroban_env_guest5guest7context28get_current_contract_address17h90ab64109761e90bE (;5;) (type 3)))
  (import "x" "3" (func $_ZN17soroban_env_guest5guest7context19get_ledger_sequence17h1b7251793b502f5cE (;6;) (type 3)))
  ...
  (import "m" "9" (func $_ZN17soroban_env_guest5guest3map26map_new_from_linear_memory17h7e49c6b0f83576abE (;9;) (type 4)))
  (import "l" "_" (func $_ZN17soroban_env_guest5guest6ledger17put_contract_data17h8dbac164d45c8b8cE (;10;) (type 4)))
  (import "b" "8" (func $_ZN17soroban_env_guest5guest3buf9bytes_len17h57d1141cd780a983E (;11;) (type 2)))
  (import "l" "6" (func $_ZN17soroban_env_guest5guest6ledger28update_current_contract_wasm17h269208d024a308d5E (;12;) (type 2)))
  (import "v" "g" (func $_ZN17soroban_env_guest5guest3vec26vec_new_from_linear_memory17h474abf0696e119a3E (;13;) (type 0)))
  (import "i" "8" (func $_ZN17soroban_env_guest5guest3int16obj_to_i128_hi6417h24d75230d84dc6d2E (;14;) (type 2)))
  (import "i" "7" (func $_ZN17soroban_env_guest5guest3int16obj_to_i128_lo6417h4098b8c5ee13fd42E (;15;) (type 2)))
  (import "i" "6" (func $_ZN17soroban_env_guest5guest3int20obj_from_i128_pieces17hd8d0c99e1246113bE (;16;) (type 0)))
  (import "b" "j" (func $_ZN17soroban_env_guest5guest3buf29symbol_new_from_linear_memory17hbdd6d6c10ec7aacfE (;17;) (type 0)))
  (memory (;0;) 17)
  ...
  (func $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..IntoVal$LT$E$C$T$GT$$GT$8into_val17hee9cccc7167cfb2eE (;18;) (type 3) (result i64)
    (local i32 i64)
  ...
  (func $_ZN113_$LT$soroban_env_common..symbol..Symbol$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$E$C$$RF$str$GT$$GT$12try_from_val17h48d670dcd6b3712eE (;19;) (type 5) (param i32 i32 i32)
  ...
  (func $_ZN84_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..EnvBase$GT$18vec_new_from_slice17h82dd80db25f38e73E (;20;) (type 6) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func $exec_op (;21;) (type 1) (param i64 i64 i64 i64) (result i64)
  ...
  (func $_ZN104_$LT$i128$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$E$C$soroban_env_common..val..Val$GT$$GT$12try_from_val17hfc4d1f059fe42329E (;22;) (type 7) (param i32 i64)
    (local i32 i64)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func $_ZN104_$LT$soroban_env_common..val..Val$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$E$C$i128$GT$$GT$12try_from_val17hfd5924f52f7cecb8E (;23;) (type 8) (param i32 i64 i64)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func $_ZN4core6option13expect_failed17h3349b800a9d695dcE (;24;) (type 9)
    call $_ZN4core9panicking9panic_fmt17ha1e661fb868a4d09E
    unreachable
  )
  (func $_ZN4core9panicking9panic_fmt17ha1e661fb868a4d09E (;25;) (type 9)
    unreachable
  )
  (func $init (;26;) (type 3) (result i64)
    i64.const 2
  )
  (func $set_plan (;27;) (type 10) (param i64 i64 i64 i64 i64) (result i64)
    (local i32 i64 i64)
    global.get $__stack_pointer
    i32.const 64
    i32.sub
  ...
  (func $upgrade (;28;) (type 2) (param i64) (result i64)
    block ;; label = @1
      block ;; label = @2
        local.get 0
        i64.const 255
