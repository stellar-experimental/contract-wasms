(module
  ...
  (export "apply_transfer_ownership" (func 54))
  ...
  (export "get_future_address" (func 76))
  (export "initialize" (func 77))
  (export "mint" (func 78))
  (export "name" (func 79))
  (export "revert_transfer_ownership" (func 80))
  ...
  (func (;27;) (type 17) (param i64 i32 i32 i32 i32)
    local.get 2
    local.get 4
    i32.ne
    if ;; label = @1
  ...
  (func (;48;) (type 20) (result i32)
    call 18
    i64.const 32
    i64.shr_u
    i32.wrap_i64
  )
  (func (;49;) (type 14) (param i64 i64 i64 i64)
    (local i32 i32 i64 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;50;) (type 12) (param i64 i64 i64 i64 i32)
    (local i32)
    block ;; label = @1
      local.get 2
      i64.eqz
  ...
  (func (;71;) (type 7) (param i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;89;) (type 11) (param i32) (result i32)
    (local i32 i64)
    local.get 0
    i64.load
    local.set 2
  ...
  (func (;91;) (type 23) (param i64 i32 i32)
