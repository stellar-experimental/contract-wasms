(module
  ...
  (export "borrow_with_zk" (func 39))
  (export "debt_of" (func 42))
  (export "deposit" (func 43))
  (export "deposit_of" (func 44))
  (export "initialize" (func 45))
  (export "pool_info" (func 46))
  (export "repay" (func 48))
