(module
  ...
  (export "disable_oracle" (func 78))
  (export "enable_oracle" (func 80))
  (export "fetch_forward_price" (func 81))
  (export "fetch_forward_prices" (func 85))
  (export "fetch_inverse_price" (func 86))
  (export "fetch_inverse_prices" (func 87))
  (export "fetch_price" (func 88))
  (export "fetch_price_threshold" (func 89))
  (export "get_cached_price" (func 90))
  (export "get_price_decimals" (func 91))
  (export "get_role_admin" (func 92))
  (export "get_rwa_oracle" (func 94))
  (export "grant_role" (func 95))
  (export "has_role" (func 97))
  (export "is_enabled" (func 99))
  (export "renounce_role" (func 100))
  (export "revoke_role" (func 103))
  (export "set_price_decimals" (func 104))
  (export "set_price_threshold" (func 105))
  ...
  (func (;114;) (type 16) (param i32 i32 i32)
