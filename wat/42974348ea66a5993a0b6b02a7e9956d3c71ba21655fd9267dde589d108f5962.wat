(module
  ...
  (export "__check_auth" (func 27))
  (export "allow_contract" (func 40))
  (export "deny_contract" (func 41))
  (export "init" (func 43))
  (export "set_signer" (func 44))
  (export "_" (global 1))
  ...
  (func (;30;) (type 15) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
