(module
  ...
  (export "set_margin_manager" (func 39))
  (export "get_pool" (func 40))
  (export "get_admin" (func 41))
  (export "get_margin_manager" (func 42))
  (export "get_base_token" (func 43))
  (export "get_quote_token" (func 44))
  (export "get_position" (func 45))
  (export "has_position" (func 47))
  (export "open_long" (func 48))
  (export "open_short" (func 52))
  (export "close_long" (func 53))
  (export "close_short" (func 54))
  (export "make_supply_collateral_request" (func 55))
  (export "make_borrow_request" (func 56))
  (export "make_repay_request" (func 57))
  (export "make_withdraw_collateral_request" (func 58))
  (export "_" (global 1))
