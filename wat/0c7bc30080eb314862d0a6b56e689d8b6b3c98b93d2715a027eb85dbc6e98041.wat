(module $arb_contract.wasm
  ...
  (import "v" "g" (func $_ZN17soroban_env_guest5guest3vec26vec_new_from_linear_memory17h7a69534ec7f9f52dE (;10;) (type 0)))
  (import "i" "8" (func $_ZN17soroban_env_guest5guest3int16obj_to_i128_hi6417h60d2806a2f2ade5aE (;11;) (type 2)))
  (import "i" "7" (func $_ZN17soroban_env_guest5guest3int16obj_to_i128_lo6417hcfff0b53a0a5f4d5E (;12;) (type 2)))
  (import "i" "6" (func $_ZN17soroban_env_guest5guest3int20obj_from_i128_pieces17hac45b0f0a8267969E (;13;) (type 0)))
  (import "l" "0" (func $_ZN17soroban_env_guest5guest6ledger17has_contract_data17hebbdbe9642454002E (;14;) (type 0)))
  (import "v" "h" (func $_ZN17soroban_env_guest5guest3vec27vec_unpack_to_linear_memory17hb7f5a7d31afc5542E (;15;) (type 1)))
  (memory (;0;) 16)
  ...
  (func $_ZN11soroban_sdk7storage8Instance3get17h6dfa3deed52465dcE (;16;) (type 4) (param i32)
    (local i64)
    i64.const 0
    local.set 1
    block ;; label = @1
  ...
  (func $_ZN11soroban_sdk7storage7Storage12has_internal17h08788c8a98895704E (;17;) (type 5) (param i64) (result i32)
    local.get 0
    i64.const 2
  ...
  (func $_ZN11soroban_sdk7storage8Instance3set17hc4be5791ca381b2aE (;18;) (type 6) (param i64)
    i64.const 166013416206
    local.get 0
    i64.const 2
  ...
  (func $execute (;19;) (type 1) (param i64 i64 i64) (result i64)
    (local i32 i32)
  ...
  (func $_ZN4core6option13expect_failed17h71e53bf5ce6cbae9E (;20;) (type 7)
    call $_ZN4core9panicking9panic_fmt17h1b94dc4a4696f2b8E
    unreachable
  )
  (func $init (;21;) (type 2) (param i64) (result i64)
    block ;; label = @1
      block ;; label = @2
        local.get 0
        i64.const 255
  ...
  (func $_ZN4core9panicking9panic_fmt17h1b94dc4a4696f2b8E (;22;) (type 7)
    unreachable
  )
  (func $update_admin (;23;) (type 2) (param i64) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $upgrade (;24;) (type 2) (param i64) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $yeet (;25;) (type 8) (param i64 i64 i64 i64) (result i64)
    (local i32 i64 i64 i32 i64 i64 i64 i64 i64 i32 i64 i64 i64 i64 i64 i64)
    global.get $__stack_pointer
    i32.const 96
    i32.sub
    local.tee 4
  ...
  (func $_ZN104_$LT$i128$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$E$C$soroban_env_common..val..Val$GT$$GT$12try_from_val17hc42d187baa1fa10aE (;26;) (type 9) (param i32 i64)
    (local i32 i64)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func $_ZN84_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..EnvBase$GT$18vec_new_from_slice17h4bf64cdbc559dd58E (;27;) (type 10) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func $_ZN11soroban_sdk3env3Env15invoke_contract17hdf7fa7eb4d0657b8E (;28;) (type 11) (param i32 i64 i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN74_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..EnvBase$GT$19vec_unpack_to_slice17h1181370086d4a204E (;29;) (type 12) (param i64 i32)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..FromVal$LT$E$C$T$GT$$GT$8from_val17h2a8fafbb5f5eb32eE (;30;) (type 0) (param i64 i64) (result i64)
    block ;; label = @1
      local.get 0
