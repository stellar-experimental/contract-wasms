(module
  ...
  (export "bump_ttl" (func 44))
  (export "claim_collateral" (func 45))
  ...
  (func (;20;) (type 13) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func (;32;) (type 17) (param i64 i64 i32)
    local.get 0
    local.get 1
    call 22
    local.get 2
  ...
  (func (;37;) (type 18) (param i32 i32 i32)
