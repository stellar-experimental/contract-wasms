(module $arb_contract.wasm
  ...
  (import "l" "2" (func $_ZN17soroban_env_guest5guest6ledger17del_contract_data17h7910ab6bbc0466c2E (;9;) (type 0)))
  (import "d" "_" (func $_ZN17soroban_env_guest5guest4call4call17h2c94d86bcfd8de36E (;10;) (type 3)))
  (import "v" "g" (func $_ZN17soroban_env_guest5guest3vec26vec_new_from_linear_memory17hccf7d0eee4b87db5E (;11;) (type 0)))
  (import "i" "8" (func $_ZN17soroban_env_guest5guest3int16obj_to_i128_hi6417h188c5cbc4568b53fE (;12;) (type 2)))
  (import "i" "7" (func $_ZN17soroban_env_guest5guest3int16obj_to_i128_lo6417h7d7a2cf2538ac14fE (;13;) (type 2)))
  (import "b" "j" (func $_ZN17soroban_env_guest5guest3buf29symbol_new_from_linear_memory17hac040a4e21b75993E (;14;) (type 0)))
  (import "i" "6" (func $_ZN17soroban_env_guest5guest3int20obj_from_i128_pieces17h9356a73aaa15a607E (;15;) (type 0)))
  (import "x" "0" (func $_ZN17soroban_env_guest5guest7context7obj_cmp17hb581ebe6d1adeb56E (;16;) (type 0)))
  (import "l" "0" (func $_ZN17soroban_env_guest5guest6ledger17has_contract_data17h25c470e51027217cE (;17;) (type 0)))
  (memory (;0;) 17)
  ...
  (func $_ZN4core3cmp9PartialEq2ne17h83e2f6c8593974f9E (;18;) (type 5) (param i64 i64) (result i32)
    local.get 0
    local.get 1
  ...
  (func $_ZN70_$LT$soroban_sdk..address..Address$u20$as$u20$core..cmp..PartialEq$GT$2eq17hcdc8bca27c771222E (;19;) (type 5) (param i64 i64) (result i32)
    local.get 0
    local.get 1
    call $_ZN17soroban_env_guest5guest7context7obj_cmp17hb581ebe6d1adeb56E
    i64.eqz
  )
  (func $_ZN4core6option15Option$LT$T$GT$3map17hecbd67b9e874147eE (;20;) (type 6) (param i32 i32)
    (local i32 i32)
    i32.const 2
    local.set 2
    block ;; label = @1
  ...
  (func $_ZN4core6result13unwrap_failed17hae3329ed235c9217E (;21;) (type 7)
    call $_ZN4core9panicking9panic_fmt17h63f599e20e4d53a5E
    unreachable
  )
  (func $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..IntoVal$LT$E$C$T$GT$$GT$8into_val17h91b48df9bf2c4574E (;22;) (type 0) (param i64 i64) (result i64)
    block ;; label = @1
      local.get 0
  ...
  (func $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..IntoVal$LT$E$C$T$GT$$GT$8into_val17hfbb5504e90caa26dE (;23;) (type 0) (param i64 i64) (result i64)
    (local i32)
  ...
  (func $_ZN126_$LT$soroban_sdk..symbol..Symbol$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$soroban_sdk..env..Env$C$$RF$str$GT$$GT$12try_from_val17h36cda578a683f1beE (;24;) (type 8) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN84_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..EnvBase$GT$18vec_new_from_slice17h6497fc45fbdcb877E (;25;) (type 9) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func $_ZN96_$LT$soroban_sdk..vec..VecTryIter$LT$T$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17h54da037699c0a59aE (;26;) (type 6) (param i32 i32)
  ...
  (func $_ZN107_$LT$soroban_sdk..vec..VecTryIter$LT$T$GT$$u20$as$u20$core..iter..traits..exact_size..ExactSizeIterator$GT$3len17h15803c4d74ad8447E (;27;) (type 10) (param i32 i32) (result i32)
    block ;; label = @1
      local.get 1
      local.get 0
      i32.lt_u
  ...
  (func $_ZN12arb_contract7storage9get_owner17h4077d23c052c5e69E (;28;) (type 4) (result i64)
    (local i64)
    block ;; label = @1
      block ;; label = @2
        i64.const 0
  ...
  (func $_ZN11soroban_sdk7storage7Storage12has_internal17heae292080498ebbeE (;29;) (type 5) (param i64 i64) (result i32)
    local.get 0
    local.get 1
  ...
  (func $_ZN4core6option13unwrap_failed17h6b511942075ba057E (;30;) (type 7)
    call $_ZN4core6result13unwrap_failed17hae3329ed235c9217E
    unreachable
  )
  (func $_ZN12arb_contract7storage13require_owner17haa4f9714c5562c37E (;31;) (type 4) (result i64)
    (local i64)
  ...
  (func $_ZN12arb_contract7storage13is_authorized17h8f19ea61cb61a2cfE (;32;) (type 11) (param i64) (result i32)
    (local i32)
    i32.const 1
    local.set 1
    block ;; label = @1
  ...
  (func $_ZN12arb_contract7storage25require_authorized_caller17h5b6dfbcbe384774eE (;33;) (type 12) (param i64)
    block ;; label = @1
      local.get 0
  ...
  (func $_ZN4core9panicking9panic_fmt17h63f599e20e4d53a5E (;34;) (type 7)
    unreachable
  )
  (func $initialize (;35;) (type 2) (param i64) (result i64)
    block ;; label = @1
      block ;; label = @2
        local.get 0
        i64.const 255
  ...
  (func $deposit (;36;) (type 0) (param i64 i64) (result i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN104_$LT$i128$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$E$C$soroban_env_common..val..Val$GT$$GT$12try_from_val17h6e22460484c038e3E (;37;) (type 13) (param i32 i64)
    (local i32 i64)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func $_ZN11soroban_sdk5token11TokenClient8transfer17he8ba6c07128bf2ebE (;38;) (type 14) (param i64 i64 i64 i64 i64)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
  ...
  (func $withdraw (;39;) (type 0) (param i64 i64) (result i64)
    (local i32 i64 i64)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $withdraw_all (;40;) (type 2) (param i64) (result i64)
  ...
  (func $_ZN11soroban_sdk5token11TokenClient7balance17h3202032c5a09d316E (;41;) (type 15) (param i32 i64 i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $add_caller (;42;) (type 2) (param i64) (result i64)
    block ;; label = @1
      local.get 0
      i64.const 255
      i64.and
  ...
  (func $remove_caller (;43;) (type 2) (param i64) (result i64)
    block ;; label = @1
      local.get 0
      i64.const 255
      i64.and
  ...
  (func $balance (;44;) (type 2) (param i64) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..FromVal$LT$E$C$T$GT$$GT$8from_val17hb34b3fb6f7565f09E (;45;) (type 0) (param i64 i64) (result i64)
    block ;; label = @1
      local.get 0
  ...
  (func $owner (;46;) (type 4) (result i64)
    call $_ZN12arb_contract7storage9get_owner17h4077d23c052c5e69E
  )
  (func $is_authorized (;47;) (type 2) (param i64) (result i64)
    block ;; label = @1
      local.get 0
      i64.const 255
      i64.and
  ...
  (func $execute_arb (;48;) (type 16) (param i64 i64 i64 i64 i64) (result i64)
  ...
  (func $_ZN12arb_contract17ArbitrageContract12perform_swap17h3bb45e71eecbb04fE (;49;) (type 17) (param i32 i32 i64 i64 i64 i64)
  ...
  (func $execute_amm_leg (;50;) (type 18) (param i64 i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func $_ZN11soroban_sdk6symbol6Symbol3new17h3fb58eec2fa36370E (;51;) (type 4) (result i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN113_$LT$soroban_env_common..symbol..Symbol$u20$as$u20$soroban_env_common..convert..TryFromVal$LT$E$C$$RF$str$GT$$GT$12try_from_val17hbf6e0e72e953d772E (;52;) (type 8) (param i32 i32 i32)
