(module
  ...
  (type (;16;) (func (param i32 i64 i32 i32 i32 i32 i32)))
  ...
  (export "write_client_info" (func 54))
  (export "read_address_id" (func 58))
  (export "read_address_at_id" (func 59))
  (export "read_client_info" (func 60))
  (export "read_client_info_using_id" (func 61))
  (export "extend_ttl" (func 62))
  (export "extend_client_info" (func 63))
  (export "_" (func 66))
  ...
  (func (;43;) (type 16) (param i32 i64 i32 i32 i32 i32 i32)
    (local i64)
    i32.const 1048585
    i32.const 17
    call 44
  ...
  (func (;54;) (type 20) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;56;) (type 6) (param i64 i32 i32)
    local.get 0
    call 57
    local.get 1
    local.get 2
  ...
  (func (;63;) (type 2) (param i64 i64 i64 i64) (result i64)
    (local i32 i32 i32)
    global.get 0
    i32.const 32
    i32.sub
