(module $flash_arb_executor.wasm
  ...
  (import "v" "_" (func $_ZN17soroban_env_guest5guest3vec7vec_new17h2dd3513b6d939a0fE (;9;) (type 2)))
  (import "v" "6" (func $_ZN17soroban_env_guest5guest3vec13vec_push_back17hc6bdd46c4433787bE (;10;) (type 1)))
  ...
  (import "v" "1" (func $_ZN17soroban_env_guest5guest3vec7vec_get17h42607e683154a8a6E (;14;) (type 1)))
  ...
  (func $_ZN4core6option13expect_failed17h3349b800a9d695dcE (;39;) (type 14) (param i32)
    call $_ZN4core9panicking9panic_fmt17ha1e661fb868a4d09E
    unreachable
  )
  ...
  (func $orchestrate (;41;) (type 15) (param i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 96
    i32.sub
  ...
  (func $set_plan (;42;) (type 3) (param i64) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 112
    i32.sub
  ...
  (func $upgrade (;43;) (type 3) (param i64) (result i64)
    block ;; label = @1
      block ;; label = @2
        local.get 0
        i64.const 255
  ...
  (func $_ (;45;) (type 13))
  (func $_ZN17compiler_builtins3mem6memcpy17hbc66828c0e85688eE (;46;) (type 16) (param i32 i32 i32) (result i32)
