(module
  ...
  (export "add_caller" (func 39))
  (export "execute" (func 41))
  (export "is_allowed" (func 44))
  (export "owner" (func 45))
  (export "remove_caller" (func 46))
  (export "sweep" (func 47))
  (export "update_owner" (func 48))
  ...
  (func (;33;) (type 14) (param i64 i64) (result i32)
    local.get 0
    local.get 1
    call 1
    i64.const 0
  ...
  (func (;41;) (type 17) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
