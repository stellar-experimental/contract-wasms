(module
  ...
  (export "accept_ownership" (func 56))
  (export "approve" (func 62))
  (export "approve_for_all" (func 63))
  (export "balance" (func 64))
  (export "batch_claim" (func 65))
  (export "batch_make_claimable" (func 67))
  (export "batch_set_claimant" (func 70))
  (export "batch_set_token_uri" (func 71))
  (export "batch_token_info" (func 72))
  (export "batch_transfer" (func 73))
  (export "burn" (func 74))
  (export "burn_from" (func 75))
  (export "claim" (func 76))
  (export "get_approved" (func 77))
  (export "get_claimant" (func 78))
  (export "get_image" (func 79))
  (export "get_owner" (func 80))
  (export "is_approved_for_all" (func 82))
  (export "is_claimable" (func 83))
  (export "max_supply" (func 84))
  (export "mint" (func 85))
  (export "name" (func 86))
  (export "owner_of" (func 88))
  (export "ping" (func 89))
  (export "renounce_ownership" (func 90))
  (export "royalty_info" (func 91))
  (export "set_claimable" (func 92))
  (export "set_claimant" (func 93))
  (export "set_image" (func 94))
  (export "set_owner" (func 95))
  (export "set_royalty_recipient" (func 96))
  (export "set_token_uri" (func 97))
  (export "symbol" (func 98))
  (export "token_uri" (func 99))
  (export "total_minted" (func 100))
  ...
  (func (;34;) (type 14) (param i32 i32 i64)
    local.get 0
    call 26
    local.get 1
    i64.extend_i32_u
  ...
  (func (;108;) (type 18) (param i32 i64 i32)
    (local i64)
    block ;; label = @1
      local.get 0
      local.get 2
  ...
  (data (;0;) (i32.const 1048576) "KPOP ROCKSKPOPM\00\01")
  (data (;1;) (i32.const 1048616) "NextTokenIdImageDataUriRoyaltyRecipientKpopTokenContractIsPausedTokenOwnerBalanceYieldVaultAccruedYieldTokenApprovedOperatorApprovedTokenUriClaimant\00\00\00\00\02")
  (data (;2;) (i32.const 1048816) "\04")
  (data (;3;) (i32.const 1048840) "live_until_ledgerOwnerPendingOwnernew_ownerold_owner\08\01\10\00\11\00\00\00*\01\10\00\09\00\00\003\01\10\00\09\00\00\00ownership_transfer\00\003\01\10\00\09\00\00\00ownership_renounced\00*\01\10\00\09\00\00\00ownership_transfer_completed")
