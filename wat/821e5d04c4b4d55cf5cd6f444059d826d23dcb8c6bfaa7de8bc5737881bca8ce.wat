(module
  ...
  (func (;28;) (type 13) (param i32 i64 i32 i32)
    local.get 0
    call 30
    local.get 1
    local.get 2
  ...
  (func (;33;) (type 15) (param i32 i64 i64 i64)
    local.get 0
    call 30
    local.get 1
    local.get 2
  ...
  (func (;52;) (type 18) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;53;) (type 19) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.le_u
    if ;; label = @1
  ...
  (data (;0;) (i32.const 1048576) "ContractCreateContractHostFnCreateContractWithCtorHostFn\00\00\10\00\08\00\00\00\08\00\10\00\14\00\00\00\1c\00\10\00\1c\00\00\00\02")
  (data (;1;) (i32.const 1048680) "\05")
  (data (;2;) (i32.const 1048704) "\03")
  (data (;3;) (i32.const 1048728) "router_get_amounts_outAdminPausedUsdcAddrRouterAddrDailyLimitUsdcPriceMapDailySpend")
  (data (;4;) (i32.const 1048840) "\04")
  (data (;5;) (i32.const 1048864) "\01")
  (data (;6;) (i32.const 1048888) "transferargscontractfn_name\00@\01\10\00\04\00\00\00D\01\10\00\08\00\00\00L\01\10\00\07\00\00\00Wasml\01\10\00\04\00\00\00executablesalt\00\00x\01\10\00\0a\00\00\00\82\01\10\00\04\00\00\00constructor_args\98\01\10\00\10\00\00\00x\01\10\00\0a\00\00\00\82\01\10\00\04")
