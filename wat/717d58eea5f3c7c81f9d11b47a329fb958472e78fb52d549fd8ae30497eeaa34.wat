(module
  ...
  (export "burn" (func 44))
  (export "extend_token_ttl" (func 46))
  (export "extend_ttl" (func 47))
  (export "initialize" (func 48))
  (export "migrate" (func 49))
  (export "mint" (func 50))
  (export "name" (func 51))
  (export "owner_of" (func 52))
  (export "set_admin" (func 53))
  (export "set_token_uri" (func 54))
  (export "symbol" (func 55))
  (export "token_uri" (func 56))
  (export "tokens_of" (func 57))
  (export "total_burned" (func 58))
  (export "total_minted" (func 59))
  ...
  (func (;64;) (type 16) (param i32 i32 i64)
    (local i64)
    block ;; label = @1
      local.get 0
      local.get 1
  ...
  (func (;66;) (type 18) (param i64 i32) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
