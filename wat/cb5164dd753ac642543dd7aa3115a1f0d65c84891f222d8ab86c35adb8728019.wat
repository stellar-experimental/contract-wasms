(module
  ...
  (export "apply_transfer_ownership" (func 29))
  (export "apply_upgrade" (func 36))
  (export "commit_transfer_ownership" (func 45))
  (export "commit_upgrade" (func 46))
  (export "contract_name" (func 48))
  (export "get_emergency_mode" (func 49))
  (export "get_future_address" (func 50))
  (export "get_value" (func 54))
  (export "get_value_updated_at" (func 55))
  (export "revert_transfer_ownership" (func 57))
  (export "revert_upgrade" (func 59))
  (export "set_emergency_mode" (func 60))
  (export "set_value" (func 62))
  ...
  (func (;63;) (type 16) (param i64 i64) (result i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
