(module
  ...
  (export "transfer_admin1" (func 49))
  (export "transfer_admin2" (func 50))
  (export "unpause" (func 51))
  (export "update_protocol_address" (func 52))
  (export "upgrade_lp_manager" (func 53))
  (export "_" (func 54))
  ...
  (func (;57;) (type 17) (param i64 i32 i32 i32) (result i64)
    (local i32 i64 i64)
    local.get 0
    i64.const 255
    i64.and
  ...
  (data (;0;) (i32.const 1048576) "\b2\00\10\00\08\00\00\00\ba\00\10\00\07\00\00\00AdminTransferredProtocolAddressUpdatedAdminTransferProposed\00\00\00\00\00\02")
  (data (;1;) (i32.const 1048672) "\03")
  (data (;2;) (i32.const 1048688) "PausedUnpausedAdmin1Admin2PendingAdmin1PendingAdmin2TokenSupportedTreasuryRelayer")
