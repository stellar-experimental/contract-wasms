(module
  ...
  (func (;22;) (type 12) (param i64 i64) (result i32)
    local.get 0
    local.get 1
    call 17
    i64.const 1
  ...
  (func (;71;) (type 16) (param i32 i64 i32)
    (local i64 i64)
    block ;; label = @1
      local.get 0
      local.get 2
  ...
  (func (;72;) (type 17) (param i64 i64 i64 i64 i64) (result i64)
    local.get 0
    i64.const 255
    i64.and
    i64.const 77
  ...
  (data (;1;) (i32.const 1048616) "NextTokenIdImageDataUriRoyaltyRecipientKpopTokenContractIsPausedTokenOwnerBalanceYieldVaultAccruedYield\00\02")
  (data (;2;) (i32.const 1048752) "\04")
  (data (;3;) (i32.const 1048768) "live_until_ledgerOwnerPendingOwnernew_ownerold_owner\c0\00\10\00\11\00\00\00\e2\00\10\00\09\00\00\00\eb\00\10\00\09\00\00\00ownership_transfer\00\00\eb\00\10\00\09\00\00\00ownership_renounced\00\e2\00\10\00\09\00\00\00ownership_transfer_completed")
