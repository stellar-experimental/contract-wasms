(module
  ...
  (export "allowance" (func 72))
  (export "approve" (func 73))
  (export "balance" (func 74))
  (export "balance_of_with_borrow_index" (func 75))
  (export "burn" (func 76))
  (export "burn_from" (func 77))
  (export "burn_scaled" (func 78))
  (export "cancel_admin_proposal" (func 82))
  (export "decimals" (func 85))
  (export "get_admin" (func 86))
  (export "get_borrow_index" (func 87))
  (export "get_borrowed_asset" (func 88))
  (export "get_incentives_contract" (func 89))
  (export "get_pending_admin" (func 90))
  (export "get_pool_address" (func 91))
  (export "initialize" (func 92))
  (export "mint_scaled" (func 93))
  (export "name" (func 94))
  (export "propose_admin" (func 95))
  (export "scaled_balance_of" (func 97))
  (export "scaled_total_supply" (func 98))
  (export "set_incentives_contract" (func 99))
  (export "symbol" (func 100))
  (export "total_supply" (func 101))
  (export "total_supply_with_index" (func 102))
  (export "transfer_from" (func 103))
  (export "upgrade" (func 104))
  (export "version" (func 105))
  (export "_" (global 1))
  (export "balance_of_with_index" (func 75))
  (export "balance_of" (func 74))
  ...
  (func (;42;) (type 15) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;55;) (type 18) (param i64 i64 i64 i64 i64 i64 i64)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;92;) (type 20) (param i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i64)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;107;) (type 9) (param i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func (;110;) (type 22) (param i32 i32) (result i32)
