(module
  ...
  (type (;11;) (func (param i64 i32 i64) (result i32)))
  ...
  (type (;18;) (func (param i64 i32 i64 i32)))
  ...
  (export "can_enforce" (func 27))
  (export "enforce" (func 32))
  (export "install" (func 40))
  (export "uninstall" (func 44))
  (export "get_threshold" (func 46))
  (export "get_signer_weights" (func 48))
  (export "set_signer_weight" (func 50))
  (export "set_threshold" (func 52))
  (export "_" (global 1))
  ...
  (func (;22;) (type 6) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;29;) (type 9) (param i32 i64 i32)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;31;) (type 11) (param i64 i32 i64) (result i32)
  ...
  (func (;32;) (type 3) (param i64 i64 i64 i64) (result i64)
    ...
    block ;; label = @1
      ...
      block ;; label = @2
        ...
        i64.const 13799729922051
        call 39
        unreachable
      end
      i64.const 13786845020163
      call 39
      unreachable
    end
    unreachable
  ...
  (func (;43;) (type 18) (param i64 i32 i64 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;45;) (type 19) (param i64 i32) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 48
    i32.sub
