(module
  ...
  (export "apply_transfer_ownership" (func 27))
  (export "apply_upgrade" (func 34))
  (export "commit_transfer_ownership" (func 43))
  (export "commit_upgrade" (func 44))
  (export "contract_name" (func 46))
  (export "get_emergency_mode" (func 47))
  (export "get_future_address" (func 48))
  (export "get_value" (func 52))
  (export "get_value_updated_at" (func 53))
  (export "revert_transfer_ownership" (func 55))
  (export "revert_upgrade" (func 57))
  (export "set_emergency_mode" (func 58))
  (export "set_value" (func 60))
