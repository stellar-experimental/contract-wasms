(module
  ...
  (export "deploy_vault" (func 46))
  (export "get_vault" (func 49))
  (export "get_vault_count" (func 50))
  (export "get_vault_wasm_hash" (func 51))
  (export "has_vault" (func 52))
  (export "initialize" (func 53))
  (export "set_admin" (func 54))
  (export "set_vault_wasm_hash" (func 55))
  ...
  (func (;37;) (type 7) (param i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
