(module
  ...
  (import "i" "0" (func (;29;) (type 2)))
  (import "l" "0" (func (;30;) (type 0)))
  (import "m" "0" (func (;31;) (type 3)))
  ...
  (export "cancel_proposal" (func 73))
  (export "cast_vote" (func 74))
  (export "create_wallet" (func 77))
  (export "get_admin" (func 84))
  (export "get_fee_manager" (func 86))
  (export "get_pop_challenge" (func 87))
  (export "get_protocol_dependencies" (func 88))
  (export "get_registry" (func 89))
  (export "get_wallet_wasm_hash" (func 90))
  (export "propose_upgrade" (func 91))
  (export "remove_voter" (func 98))
  (export "update_admin" (func 100))
  (export "update_fee_manager" (func 101))
  (export "update_registry" (func 102))
  (export "update_social_router" (func 103))
  (export "_" (global 1))
  ...
  (func (;43;) (type 10) (param i32) (result i32)
    (local i64 i32 i32)
    local.get 0
    i64.load
    local.set 1
  ...
  (func (;59;) (type 15) (param i64) (result i32)
    (local i32)
    i32.const 1001
    local.set 1
    block ;; label = @1
  ...
  (func (;64;) (type 1) (result i64)
    (local i32 i32 i64 i64 i64 i32 i32 i64 i64 i32 i64 i64 i64)
    global.get 0
    i32.const 16
    i32.sub
    local.tee 0
  ...
  (func (;77;) (type 13) (param i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;109;) (type 19) (param i32 i32)
    (local i32 i64 i64)
    global.get 0
    i32.const 16
    i32.sub
