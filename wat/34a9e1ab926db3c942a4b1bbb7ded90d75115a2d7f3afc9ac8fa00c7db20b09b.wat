(module
  ...
  (export "claim_zk" (func 47))
  (export "deposit" (func 48))
  (export "get_pending" (func 49))
  (export "get_vk" (func 50))
  (export "is_deployed" (func 51))
  (export "reclaim_expired" (func 52))
  (export "set_verification_key" (func 53))
  (export "_" (global 1))
  (export "__data_end" (global 2))
  (export "__heap_base" (global 3))
  (elem (;0;) (i32.const 1) func 72 82 83 81)
  ...
  (func (;58;) (type 8) (param i32 i32 i32 i32)
    local.get 1
    i32.const 32
    i32.eq
    if ;; label = @1
  ...
  (func (;77;) (type 20) (param i32 i64 i32 i32)
    local.get 1
    i64.const 4
    local.get 2
    i64.extend_i32_u
  ...
  (func (;79;) (type 11) (param i64) (result i32)
    local.get 0
    i64.const 32
    i64.shr_u
    i32.wrap_i64
  ...
  (func (;82;) (type 2) (param i32 i32) (result i32)
    ...
    if ;; label = @1
      ...
      loop ;; label = @2
        ...
        i32.const 1
        i32.shl
        i32.load16_u offset=1049600 align=1
        i32.store16 align=1
        local.get 3
        i32.const 2
        i32.sub
  ...
  (func (;85;) (type 21) (param i32 i32 i32 i32) (result i32)
    block ;; label = @1
      local.get 2
      i32.const 1114112
      i32.eq
