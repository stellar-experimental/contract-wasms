(module
  ...
  (export "withdraw_collateral" (func 66))
  (export "get_yield" (func 70))
  (export "get_emissions" (func 72))
  (export "claim_emissions" (func 74))
  (export "set_yield_distributor" (func 75))
  (export "set_adapter_registry" (func 76))
  (export "set_cusd_manager" (func 77))
  (export "get_yield_distributor" (func 78))
  (export "get_adapter_registry" (func 79))
  (export "get_cusd_manager" (func 80))
  (export "set_admin" (func 81))
  (export "get_apy" (func 82))
  (export "upgrade" (func 83))
  (export "harvest_yield" (func 84))
  (export "recompound_yield" (func 88))
  (export "finalize_distribution" (func 89))
  (export "get_pending_harvest" (func 90))
  (export "cancel_harvest" (func 91))
  (export "_" (func 93))
  ...
  (func (;31;) (type 13) (param i64) (result i32)
    local.get 0
    i64.const 2
    call 18
    i64.const 1
  ...
  (func (;59;) (type 22) (param i64 i64 i64) (result i32)
    (local i32)
    i32.const 1
    local.set 3
    block ;; label = @1
  ...
  (func (;62;) (type 23) (param i64 i64 i64 i64 i64) (result i64)
    local.get 0
    i64.const 255
    i64.and
    i64.const 77
  ...
  (func (;64;) (type 17) (param i32 i64 i64 i64 i64 i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;65;) (type 17) (param i32 i64 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;87;) (type 24) (param i64 i64 i64 i64 i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (data (;4;) (i32.const 1048704) "deposit_collateralwithdraw_collateralset_yield_distributorset_adapter_registryset_cusd_managerset_adminharvest_yieldrecompound_yieldfinalize_distributioncancel_harvestdepositissue_cusdwithdrawdistribute_yieldtransferadvance_epochget_cusd_idget_adapteris_supported_assetis_distribution_availableget_current_epochamountassetprotocolstate\00\b7\01\10\00\06\00\00\00\bd\01\10\00\05\00\00\00\c2\01\10\00\08\00\00\00\ca\01\10\00\05\00\00\00OwnerAdminCUSDManagerAdapterRegistryYieldDistributorPendingHarvestargscontractfn_name\00\00\002\02\10\00\04\00\00\006\02\10\00\08\00\00\00>\02\10\00\07\00\00\00contextsub_invocations\00\00`\02\10\00\07\00\00\00g\02\10\00\0f\00\00\00claim_yielddeposit_authwithdraw_authclaim_yield_authclaim_emissionsclaim_emissions_authget_emissionsget_balanceupdate_epoch_principal")
