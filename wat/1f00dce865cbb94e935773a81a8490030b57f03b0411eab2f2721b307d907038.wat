(module
  ...
  (export "backing" (func 60))
  (export "balance" (func 62))
  (export "burn" (func 64))
  (export "burn_from" (func 67))
  (export "decimals" (func 69))
  (export "execute_with_interchain_token" (func 71))
  (export "get_admin" (func 79))
  (export "get_existing_roles" (func 80))
  (export "get_role_admin" (func 82))
  (export "get_role_member" (func 84))
  (export "get_role_member_count" (func 87))
  (export "grant_role" (func 89))
  (export "has_role" (func 91))
  (export "interchain_token_service" (func 93))
  (export "name" (func 94))
  (export "renounce_admin" (func 95))
  (export "renounce_role" (func 97))
  (export "revoke_role" (func 100))
  (export "set_axelar_config" (func 101))
  (export "set_role_admin" (func 102))
  (export "symbol" (func 104))
  (export "total_supply" (func 105))
  (export "transfer" (func 107))
  (export "transfer_admin_role" (func 110))
  (export "transfer_from" (func 113))
  (export "unwrap" (func 114))
  (export "upgrade" (func 116))
  (export "wrap" (func 117))
  (export "wrapped_token" (func 118))
  (export "_" (global 1))
  ...
  (func (;40;) (type 18) (param i64 i64 i64 i64 i64) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;45;) (type 11) (param i64 i64 i64)
  ...
  (func (;58;) (type 20) (param i64 i64 i64 i64 i32)
    (local i32 i32 i32 i32 i64)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;65;) (type 21) (param i32 i32 i64 i64)
  ...
  (func (;71;) (type 23) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;77;) (type 26) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;109;) (type 27) (param i64 i64 i64 i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;111;) (type 16) (result i32)
    call 20
    i64.const 32
    i64.shr_u
    i32.wrap_i64
  )
  (func (;112;) (type 17) (param i32 i64 i32 i32)
    local.get 0
    call 43
    local.get 1
    local.get 2
  ...
  (func (;115;) (type 28) (param i64 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;120;) (type 5) (param i32 i64 i64)
    local.get 1
    i64.const 63
    i64.shr_s
    local.get 2
  ...
  (func (;123;) (type 30) (param i64 i32 i32 i32 i32)
    local.get 2
    local.get 4
    i32.ne
    if ;; label = @1
  ...
  (func (;128;) (type 5) (param i32 i64 i64)
    local.get 0
    local.get 1
    local.get 2
    i64.const 1
  ...
  (func (;129;) (type 12) (param i64 i64)
    i32.const 1049416
    local.get 0
    local.get 1
    i64.const 2
  ...
  (func (;130;) (type 17) (param i32 i64 i32 i32)
    local.get 0
    call 41
    local.get 1
    local.get 2
  ...
  (func (;131;) (type 32) (param i32 i64 i64 i64)
    local.get 0
    call 41
    local.get 1
    local.get 2
  ...
  (data (;0;) (i32.const 1048576) "upgraderWxrpItsWxrpTokenIdTrustedChainTrustedSourceSpEcV1\c1\c6Rb\ccJ9\11SpEcV17\ae\8d\9f\9a\82mGSpEcV1\d9\a7;\f0\8aG\d5BSpEcV1q{U\db\f8\050\b3SpEcV1A\f0\9e`\95\e3\ad\c0SpEcV1\e4\0bD\edj\14\03!previous_admin\00\00\00\87\00\10\00\0e\00\00\00admin_transfer_completednew_admin\00\00\00\aa\02\10\00\11\00\00\00\b8\00\10\00\09\00\00\00admin_transfer_initiatedaddress\00\ec\00\10\00\07\00\00\00\aa\02\10\00\11\00\00\00\00\00\00\00\05")
  (data (;1;) (i32.const 1048864) "indexrole\00\00\00 \01\10\00\05\00\00\00%\01\10\00\04\00\00\00ExistingRolesRoleAccountsHasRoleRoleAccountsCountRoleAdminAdminPendingAdmin\00\06")
  (data (;2;) (i32.const 1048992) "caller\00\00\a0\01\10\00\06\00\00\00role_grantedrole_revokedadmin_renouncednew_admin_roleprevious_admin_role\d7\01\10\00\0e\00\00\00\e5\01\10\00\13\00\00\00role_admin_changedInterfaces_MigratingSpEcV1H\dd\d6\b3k\f8 [SpEcV1=\cf\bb\92\b5(\e7\fbSpEcV1\19\82\17P\baC\a0\92SpEcV1)\ebP\cd \daY\c4SpEcV1\d3\00\7fg:Z\92\db\00\00\00\00\0e\f3\ad\9f\00\00\00\00\0e\b7\ba\e2\b3y\e7\00ownerTotalSupply\0e\eaN\dfum\02\00namesymbollive_until_ledgerBalance\00\00\00\00\00\00\0e\f9\ec\ca\00\00\00\00decimals\d0\02\10\00\08\00\00\00\a0\02\10\00\04\00\00\00\a4\02\10\00\06\00\00\00spender\00\88\02\10\00\05\00\00\00\f0\02\10\00\07\00\00\00amount\00\00\08\03\10\00\06\00\00\00\aa\02\10\00\11\00\00\00MetaAllowance")
  (data (;3;) (i32.const 1049416) "\01")
  (data (;4;) (i32.const 1049440) "\08\03\10\00\06\00\00\00to_muxed_id\00\08\03\10\00\06\00\00\00h\03\10\00\0b")
