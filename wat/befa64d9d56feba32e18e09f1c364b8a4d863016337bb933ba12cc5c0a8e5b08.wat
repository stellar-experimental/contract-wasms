(module
  ...
  (export "is_account_vaulted" (func 94))
  (export "is_actually_vaulted" (func 95))
  (export "is_pool" (func 96))
  (export "is_router" (func 97))
  (export "list_pools" (func 98))
  (export "list_routers" (func 99))
  (export "max_supply" (func 100))
  (export "mint" (func 101))
  (export "name" (func 102))
  (export "pool_wasm_hash" (func 103))
  (export "register_pool_address" (func 104))
  (export "register_router_address" (func 105))
  (export "remove_pool_address" (func 106))
  (export "remove_router_address" (func 108))
  (export "router_wasm_hash" (func 109))
  (export "safety_limit" (func 110))
  (export "set_admin" (func 111))
  (export "symbol" (func 112))
  (export "total_mass" (func 113))
  ...
  (func (;38;) (type 22) (param i32 i64 i64 i64)
    local.get 0
    call 30
    local.get 1
    local.get 2
  ...
  (func (;55;) (type 24) (result i32)
    call 19
    i64.const 32
    i64.shr_u
    i32.wrap_i64
  )
  (func (;56;) (type 7) (param i64) (result i32)
    local.get 0
    i64.const 10
    call 130
  )
  ...
  (func (;58;) (type 25) (param i64 i64 i64 i64)
  ...
  (func (;81;) (type 13) (param i64 i64 i64)
    i32.const 1048927
    i32.const 10
    call 49
    local.get 2
  ...
  (func (;82;) (type 18) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func (;121;) (type 27) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.le_u
    if ;; label = @1
  ...
  (func (;123;) (type 16) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;126;) (type 20) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      local.get 3
      i32.const 64
  ...
  (func (;127;) (type 28) (param i32 i64 i64 i64 i64 i32)
    (local i32 i32 i32 i64 i64)
    global.get 0
    i32.const 96
    i32.sub
  ...
  (func (;128;) (type 17) (param i32 i32 i64)
    (local i64)
    block ;; label = @1
      local.get 0
      local.get 1
  ...
  (data (;4;) (i32.const 1048696) "\05")
  (data (;5;) (i32.const 1048720) "\0c")
  (data (;6;) (i32.const 1048744) "\0d")
  (data (;7;) (i32.const 1048800) "AdminNameSymbolDecimalsTotalMassTotalSupplyBalanceVaultedAllowanceAllowanceExpiryApprovedPoolsApprovedRoutersPoolListRouterListburn_eventmint_eventamountexpiration_ledger\00\00s\01\10\00\06\00\00\00y\01\10\00\11\00\00\00approve_eventvaulted_eventtransfer_eventnamesymbol\00\00\c4\01\10\00\04\00\00\00\c8\01\10\00\06\00\00\00initialized_eventadmin_changed_eventregisteredwasm_hash\00\04\02\10\00\0a\00\00\00\0e\02\10\00\09\00\00\00pool_registered_eventrouter_registered_eventWasmStellarAssetAccount\00T\02\10\00\04\00\00\00X\02\10\00\0c\00\00\00d\02\10\00\07")
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\06cliver\00\00\00\00\00/25.1.0#a048a57a75762458b487052e0021ea704a926bee\00\00\00\00\00\00\00\00\0bsource_repo\00\00\00\00\1bgithub:skyhitz/hitz-gravity\00")
)
