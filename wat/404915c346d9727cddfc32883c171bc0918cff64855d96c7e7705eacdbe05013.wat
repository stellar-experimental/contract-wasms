(module
  ...
  (export "claim_timeout" (func 77))
  (export "commit" (func 79))
  (export "compute_commitment" (func 80))
  (export "find_match" (func 81))
  ...
  (func (;80;) (type 3) (param i64 i64 i64 i64) (result i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
