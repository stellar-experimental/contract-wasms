(module $broker_contract.wasm
  ...
  (func $_ZN15broker_contract6Broker16find_token_index17h409ea8b1769232e2E.llvm.11295373314256830043 (;34;) (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $_ZN15broker_contract6Broker13execute_steps17h30ebb3ae78b9082dE (;38;) (type 11) (param i32 i32 i32 i64 i64 i64)
    (local i32 i64 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i32 i64 i64 i64 i64 i64 i64 i64)
    global.get $__stack_pointer
    i32.const 368
    i32.sub
    local.tee 6
        ...
        loop ;; label = @3
          ...
          block ;; label = @4
            block ;; label = @5
              ...
              i32.add
              local.get 16
              call $_ZN15broker_contract6Broker16find_token_index17h409ea8b1769232e2E.llvm.11295373314256830043
              local.set 10
              local.get 1
              local.get 6
              i32.const 200
