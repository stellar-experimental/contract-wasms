(module
  ...
  (export "is_soulbound" (func 61))
  (export "name" (func 62))
  (export "owner_of" (func 64))
  (export "public_mint" (func 65))
  (export "public_mint_soulbound" (func 66))
  (export "set_token_uri" (func 67))
  ...
  (func (;43;) (type 19) (param i64 i64 i32)
    (local i32 i32 i32)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;75;) (type 21) (param i64 i64 i32 i64) (result i64)
