(module
  ...
  (export "accept_admin_transfer" (func 37))
  ...
  (func (;31;) (type 19) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;35;) (type 11) (param i64 i64 i64)
  ...
  (func (;48;) (type 20) (param i64 i64 i64 i64 i32)
    (local i32 i32 i32 i32 i64)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;53;) (type 21) (param i32 i32 i64 i64)
  ...
  (func (;56;) (type 22) (param i64 i64 i64 i64)
    (local i32 i32 i64 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;75;) (type 23) (param i32 i64) (result i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;81;) (type 11) (param i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;90;) (type 24) (param i64 i64 i64 i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;94;) (type 16) (param i32 i64 i32 i32)
    local.get 0
    call 32
    local.get 1
    local.get 2
  ...
  (func (;95;) (type 7) (param i64 i64 i64 i64) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;108;) (type 4) (param i32 i64 i64)
    local.get 0
    local.get 1
    local.get 2
    i64.const 1
  ...
  (data (;0;) (i32.const 1048576) "upgraderminterSpEcV1\c1\c6Rb\ccJ9\11SpEcV17\ae\8d\9f\9a\82mGSpEcV1\d9\a7;\f0\8aG\d5BSpEcV1q{U\db\f8\050\b3SpEcV1A\f0\9e`\95\e3\ad\c0SpEcV1\e4\0bD\edj\14\03!previous_adminb\00\10\00\0e\00\00\00admin_transfer_completednew_admin\00\00\00j\02\10\00\11\00\00\00\90\00\10\00\09\00\00\00admin_transfer_initiatedaddress\00\c4\00\10\00\07\00\00\00j\02\10\00\11\00\00\00\00\00\00\00\05")
  (data (;1;) (i32.const 1048824) "indexrole\00\00\00\f8\00\10\00\05\00\00\00\fd\00\10\00\04\00\00\00ExistingRolesRoleAccountsHasRoleRoleAccountsCountRoleAdminAdminPendingAdmin\00\06")
  (data (;2;) (i32.const 1048952) "caller\00\00x\01\10\00\06\00\00\00role_grantedrole_revokedadmin_renouncednew_admin_roleprevious_admin_role\af\01\10\00\0e\00\00\00\bd\01\10\00\13\00\00\00role_admin_changedSpEcV1H\dd\d6\b3k\f8 [SpEcV1=\cf\bb\92\b5(\e7\fbSpEcV1\19\82\17P\baC\a0\92SpEcV1)\ebP\cd \daY\c4SpEcV1\d3\00\7fg:Z\92\db\0e\f3\ad\9f\00\00\00\00\0e\b7\ba\e2\b3y\e7\00ownerTotalSupply\0e\eaN\dfum\02\00namesymbollive_until_ledgerBalance\00\00\00\00\00\00\0e\f9\ec\ca\00\00\00\00decimals\90\02\10\00\08\00\00\00`\02\10\00\04\00\00\00d\02\10\00\06\00\00\00spender\00H\02\10\00\05\00\00\00\b0\02\10\00\07\00\00\00amount\00\00\c8\02\10\00\06\00\00\00j\02\10\00\11\00\00\00MetaAllowance")
  (data (;3;) (i32.const 1049352) "\01")
  (data (;4;) (i32.const 1049376) "\c8\02\10\00\06\00\00\00to_muxed_id\00\c8\02\10\00\06\00\00\00(\03\10\00\0b")
