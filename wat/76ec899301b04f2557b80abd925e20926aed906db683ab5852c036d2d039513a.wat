(module
  ...
  (export "initialize" (func 13))
  (export "rotate_guardian" (func 15))
  (export "bump_nonce" (func 16))
  (export "owner_key_len" (func 17))
  (export "guardian_key_len" (func 18))
  (export "nonce_key_len" (func 19))
  (export "owner_key_xdr" (func 20))
  (export "guardian_key_xdr" (func 21))
  (export "nonce_key_xdr" (func 22))
  (export "_" (global 1))
