(module
  ...
  (global (;2;) i32 i32.const 1048955)
  ...
  (func (;53;) (type 15) (param i32 i32) (result i32)
    block ;; label = @1
      local.get 1
      local.get 0
      i32.lt_u
  ...
  (func (;80;) (type 18) (param i32 i32 i32)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
