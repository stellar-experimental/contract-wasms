(module
  ...
  (export "get_borrow_rate" (func 43))
  (export "get_supply_rate" (func 45))
  (export "set_params" (func 47))
  (export "propose_upgrade_wasm" (func 48))
  (export "upgrade_wasm" (func 51))
  (export "_" (global 1))
  ...
  (func (;25;) (type 15) (param i64) (result i32)
    local.get 0
    i64.const 1
    call 17
    i64.const 1
  ...
  (func (;28;) (type 16) (param i32) (result i32)
    local.get 0
    call 23
    call 25
  )
  (func (;29;) (type 17) (param i32 i64 i64)
    local.get 0
    call 23
    local.get 1
    local.get 2
  ...
  (func (;41;) (type 20) (param i32 i32) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;44;) (type 12) (param i32 i64 i64 i64 i64 i64 i64)
  ...
  (func (;46;) (type 12) (param i32 i64 i64 i64 i64 i64 i64)
  ...
  (data (;0;) (i32.const 1048576) "GDYDTMY46RNAUIIUVG6RPD2D3I3ES4J2SSXGCKIQP2OET4Q5PV75LSPLBaseRatePerYearMultiplierPerYearJumpMultiplierPerYearKinkAdminPendingUpgradeHashPendingUpgradeEtamodel_initializedbase_ratejump_multiplierkinkmultiplier\aa\00\10\00\09\00\00\00\b3\00\10\00\0f\00\00\00\c2\00\10\00\04\00\00\00\c6\00\10\00\0a\00\00\00model_params_updated")
