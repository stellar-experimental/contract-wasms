(module
  ...
  (export "get_approved" (func 40))
  (export "initialize" (func 41))
  (export "is_approved_for_all" (func 42))
  (export "mint" (func 43))
  (export "name" (func 44))
  (export "owner_of" (func 45))
  (export "revoke" (func 46))
  (export "set_admin" (func 48))
  (export "set_approval_for_all" (func 49))
  (export "symbol" (func 50))
  (export "token_count" (func 51))
  (export "token_of_owner_by_index" (func 52))
  (export "token_uri" (func 53))
  (export "transfer" (func 54))
  (export "transfer_from" (func 55))
  (export "update_uri" (func 56))
  (export "upgrade" (func 57))
  (export "_" (global 1))
  (export "balance_of" (func 37))
  ...
  (func (;55;) (type 14) (param i64 i64 i64 i64) (result i64)
    local.get 0
    i64.const 255
    i64.and
    i64.const 77
