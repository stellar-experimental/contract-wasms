(module
  ...
  (export "commit_bid" (func 56))
  (export "create_auction" (func 59))
  (export "extend_ttl" (func 60))
  (export "get_auction" (func 61))
  (export "get_commitment" (func 62))
  (export "initialize" (func 63))
  (export "reveal_bid" (func 64))
  ...
  (func (;59;) (type 19) (param i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const 128
    i32.sub
