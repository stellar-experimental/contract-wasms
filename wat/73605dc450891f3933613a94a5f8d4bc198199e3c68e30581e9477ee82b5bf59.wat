(module
  ...
  (export "apply_transfer_ownership" (func 16))
  (export "apply_upgrade" (func 33))
  ...
  (export "init_admin" (func 50))
  (export "revert_transfer_ownership" (func 51))
  ...
  (func (;42;) (type 8) (param i64 i64 i64) (result i64)
    (local i32 i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func (;62;) (type 16) (param i64 i64) (result i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
