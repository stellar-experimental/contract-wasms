(module $broker_contract.wasm
  ...
  (func $_ZN15broker_contract6Broker16find_token_index17h409ea8b1769232e2E.llvm.16990940761747289620 (;34;) (type 0) (param i32 i32 i32) (result i32)
        ...
        loop ;; label = @3
          ...
          block ;; label = @4
            block ;; label = @5
              ...
              i32.add
              local.get 16
              call $_ZN15broker_contract6Broker16find_token_index17h409ea8b1769232e2E.llvm.16990940761747289620
              local.set 10
              local.get 1
              local.get 6
              i32.const 200
