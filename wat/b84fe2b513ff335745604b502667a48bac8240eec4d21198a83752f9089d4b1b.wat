(module
  ...
  (export "revert_upgrade" (func 63))
  (export "set_emergency_mode" (func 64))
  (export "set_privileged_addrs" (func 66))
  (export "set_total_supply" (func 67))
  ...
  (func (;74;) (type 16) (param i64 i64) (result i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
