(module
  ...
  (export "add_governor" (func 38))
  (export "extend_ttl" (func 39))
  (export "get_admin" (func 40))
  (export "get_existing_roles" (func 41))
  (export "get_role_admin" (func 43))
  (export "get_role_member" (func 46))
  (export "get_role_member_count" (func 47))
  (export "has_role" (func 48))
  (export "is_compatible_successor" (func 49))
  (export "is_governor" (func 50))
  (export "is_governor_or_guardian" (func 51))
  (export "remove_governor" (func 52))
  (export "set_access_control_manager" (func 54))
  (export "_" (global 1))
  ...
  (func (;53;) (type 14) (param i64 i64 i64)
    (local i32 i32 i32 i64 i64 i64 i64 i64 i32 i64)
    global.get 0
    i32.const 144
    i32.sub
    local.tee 3
