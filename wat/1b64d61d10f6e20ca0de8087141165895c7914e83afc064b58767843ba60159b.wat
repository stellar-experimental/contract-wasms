(module
  ...
  (export "get_relayer_address" (func 28))
  (export "get_treasury_address" (func 30))
  (export "initialize" (func 31))
  (export "is_paused" (func 33))
  (export "is_token_supported" (func 34))
  (export "pause" (func 35))
  (export "unpause" (func 36))
  (export "update_protocol_address" (func 37))
  (export "upgrade_lp_manager" (func 39))
  (export "_" (func 41))
  ...
  (func (;16;) (type 4) (param i64) (result i32)
    local.get 0
    i64.const 1
    call 12
    i64.const 1
  ...
  (func (;22;) (type 8) (param i64 i32 i64) (result i32)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;41;) (type 12))
  (data (;0;) (i32.const 1048576) "TreasuryAggregator\00\00\00\00\10\00\08\00\00\00\08\00\10\00\0a\00\00\00ProtocolAddressUpdatedPausedUnpausedAdminRelayerMaxBpsTokenSupported\02\00\00\00\00\00\00\00\03\00\00\00\01\00\00\00\03\00\00\00\02\00\00\00\03\00\00\00\03\00\00\00\03\00\00\00\04\00\00\00\03\00\00\00\05\00\00\00")
