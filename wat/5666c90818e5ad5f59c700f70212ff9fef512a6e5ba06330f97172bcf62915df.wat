(module
  ...
  (func (;187;) (type 38) (param i32 i64 i64 i32 i32)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;188;) (type 15) (param i64 i64 i32) (result i64)
    (local i32 i32 i32)
    block (result i64) ;; label = @1
      global.get 0
      i32.const 48
  ...
  (func (;189;) (type 6) (param i32) (result i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;190;) (type 14) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 32
    i32.sub
