(module
  ...
  (import "c" "1" (func (;17;) (type 1)))
  (import "v" "b" (func (;18;) (type 0)))
  ...
  (export "add_claim" (func 62))
  (export "get_claim" (func 70))
  (export "get_claim_ids_by_topic" (func 72))
  (export "get_claim_topics" (func 73))
  (export "get_identity_details" (func 74))
  (export "get_owner" (func 80))
  (export "get_token_details" (func 81))
  (export "remove_claim" (func 82))
  ...
  (func (;62;) (type 17) (param i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;78;) (type 18) (param i64 i32 i32 i32 i32)
    local.get 2
    local.get 4
    i32.ne
    if ;; label = @1
