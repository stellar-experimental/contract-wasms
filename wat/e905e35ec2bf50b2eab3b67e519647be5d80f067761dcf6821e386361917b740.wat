(module
  ...
  (export "get_decimals" (func 48))
  (export "get_max_age_secs" (func 49))
  (export "get_price" (func 50))
  (export "get_reflector" (func 54))
  (export "refresh_decimals" (func 55))
  ...
  (func (;56;) (type 16) (param i64 i64 i64) (result i32)
    block ;; label = @1
      local.get 0
      local.get 1
      local.get 2
