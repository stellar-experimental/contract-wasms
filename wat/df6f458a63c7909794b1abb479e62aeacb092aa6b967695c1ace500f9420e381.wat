(module
  ...
  (export "get_identity" (func 26))
  (export "initialize" (func 28))
  (export "is_eligible" (func 29))
  (export "is_nullifier_used" (func 30))
  (export "register_identity" (func 31))
  (export "set_verifier" (func 34))
  (export "_" (global 1))
  ...
  (func (;21;) (type 8) (param i32 i64 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
