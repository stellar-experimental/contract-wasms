(module
  ...
  (export "fake_mint" (func 9))
  (export "fire" (func 12))
  (export "fire_many" (func 13))
  (export "fire_negative" (func 14))
  (export "inner_pan" (func 16))
  (export "outer_pan" (func 19))
  (export "_" (func 20))
  ...
  (func (;13;) (type 8) (param i64 i64 i64 i64 i64) (result i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;14;) (type 7) (param i64 i64 i64 i64) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
