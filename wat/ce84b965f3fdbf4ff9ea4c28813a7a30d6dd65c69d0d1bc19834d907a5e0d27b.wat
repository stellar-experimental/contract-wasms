(module
  ...
  (func (;48;) (type 13) (param i64 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;52;) (type 19) (param i64 i32 i32) (result i32)
    (local i32)
    i32.const 5
    local.set 3
    block ;; label = @1
  ...
  (func (;55;) (type 8) (param i32 i64 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;61;) (type 14) (param i64) (result i32)
    local.get 0
    call 10
    i64.const 32
    i64.shr_u
  ...
  (func (;88;) (type 25) (param i32 i32 i32) (result i32)
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\06cliver\00\00\00\00\00/23.4.0#fc6745f3d4e90d1ef68d14d0ae947404768fa5c0\00\00\00\00\00\00\00\00\0bhome_domain\00\00\00\00\10voltacircuit.com\00\00\00\00\00\00\00\0bsource_repo\00\00\00\00%github:VoltaHQ/smart-contract-soroban\00\00\00\00\00\00\00\00\00\00\0dsource_commit\00\00\00\00\00\00(6bc166b49b188fc4d10f0f66bb9a65c265666afc")
)
