(module
  ...
  (export "calculate_protocol_fee" (func 65))
  (export "create_order" (func 66))
  (export "emergency_refund" (func 70))
  (export "execute_refund_transfer" (func 71))
  (export "execute_settlement_transfer" (func 74))
  ...
  (func (;69;) (type 20) (param i64 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;87;) (type 13) (param i32 i64 i64 i64 i64)
