(module
  ...
  (global (;1;) i32 i32.const 1048945)
  (global (;2;) i32 i32.const 1049011)
  (global (;3;) i32 i32.const 1049024)
  (export "memory" (memory 0))
  (export "__constructor" (func 25))
  (export "apply_transfer_ownership" (func 31))
  (export "apply_upgrade" (func 38))
  (export "commit_transfer_ownership" (func 49))
  (export "commit_upgrade" (func 50))
  (export "contract_name" (func 52))
  (export "get_emergency_mode" (func 53))
  (export "get_future_address" (func 54))
  (export "get_privileged_addrs" (func 58))
  (export "revert_transfer_ownership" (func 59))
  (export "revert_upgrade" (func 61))
  (export "set_emergency_mode" (func 62))
  (export "set_privileged_addrs" (func 64))
  (export "set_total_supply" (func 65))
  ...
  (data (;0;) (i32.const 1048576) "LockerFeedTotalSupplydisable_emergency_modeenable_emergency_modeset_privileged_addrsapply_transfer_ownershipcommit_transfer_ownershiprevert_transfer_ownershipAdminEmergencyAdminOperatorOperationsAdminPauseAdminEmPauseAdminsSystemFeeAdminFutureAdminFutureEmergencyAdminTransferOwnershipDeadlineEmAdminTransferOwnershipDeadlineEmergencyModeRewardsAdminEmergencyPauseAdminapply_upgradecommit_upgraderevert_upgradeUpgradeDeadlineFutureWASM")
