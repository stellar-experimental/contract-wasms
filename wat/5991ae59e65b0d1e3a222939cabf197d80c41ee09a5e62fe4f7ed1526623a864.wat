(module
  ...
  (import "c" "3" (func (;21;) (type 4)))
  (import "m" "2" (func (;22;) (type 0)))
  ...
  (export "add_member" (func 113))
  (export "add_signer" (func 116))
  (export "approve" (func 117))
  (export "cancel" (func 119))
  (export "execute" (func 120))
  (export "get_member" (func 121))
  (export "get_members" (func 122))
  (export "get_proposal" (func 123))
  (export "get_proposal_ids" (func 124))
  (export "get_threshold" (func 125))
  (export "propose" (func 126))
  (export "reject" (func 127))
  (export "remove_member" (func 128))
  (export "remove_signer" (func 129))
  (export "set_threshold" (func 130))
  (export "_" (global 1))
  ...
  (func (;44;) (type 19) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;51;) (type 20) (param i64 i32 i32 i32 i32)
    local.get 2
    local.get 4
    i32.ne
    if ;; label = @1
  ...
  (func (;63;) (type 22) (param i64 i32) (result i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;64;) (type 23) (param i32 i64 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;94;) (type 8) (param i32) (result i32)
    (local i32 i64)
    local.get 0
    i64.load
    local.set 2
  ...
  (func (;97;) (type 15) (param i32 i32 i32 i32)
    local.get 1
    local.get 3
    i32.le_u
    if ;; label = @1
  ...
  (func (;109;) (type 8) (param i32) (result i32)
    (local i32)
    local.get 0
    i32.load
    local.tee 0
  ...
  (func (;133;) (type 8) (param i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;134;) (type 6) (param i32 i32 i32)
    (local i32 i32 i32 i64)
    block (result i64) ;; label = @1
      block ;; label = @2
        local.get 2
  ...
  (func (;135;) (type 8) (param i32) (result i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 96
    i32.sub
  ...
  (func (;137;) (type 28) (param i32 i32 i32 i32) (result i32)
    local.get 1
    local.get 3
    i32.eq
    if (result i32) ;; label = @1
  ...
  (func (;138;) (type 18) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
  ...
  (func (;140;) (type 18) (param i32 i32 i32) (result i32)
  ...
  (func (;141;) (type 10) (param i32 i64 i64)
    (local i64)
    i64.const 1
    local.set 3
    block ;; label = @1
