(module
  ...
  (export "approve_for_all" (func 53))
  (export "balance" (func 55))
  (export "extend_ttl" (func 56))
  (export "get_approved" (func 57))
  (export "initialize" (func 58))
  (export "is_approved_for_all" (func 59))
  (export "is_soulbound" (func 60))
  (export "name" (func 61))
  (export "owner_of" (func 63))
  (export "public_mint" (func 64))
  (export "public_mint_soulbound" (func 65))
  (export "set_token_uri" (func 66))
  (export "symbol" (func 67))
  (export "token_uri" (func 68))
  (export "total_minted" (func 69))
  ...
  (func (;29;) (type 12) (param i32 i32 i64)
    local.get 0
    call 22
    local.get 1
    i64.extend_i32_u
  ...
  (func (;40;) (type 17) (param i32 i64) (result i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;42;) (type 19) (param i64 i64 i32)
    (local i32 i32 i32)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;62;) (type 10) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func (;73;) (type 21) (param i64 i64 i32 i64) (result i64)
  ...
  (func (;74;) (type 12) (param i32 i32 i64)
    (local i64)
    block ;; label = @1
      local.get 0
      local.get 1
