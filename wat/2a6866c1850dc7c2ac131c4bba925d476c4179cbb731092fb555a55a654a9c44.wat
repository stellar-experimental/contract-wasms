(module
  ...
  (func (;32;) (type 12) (param i32 i64 i32)
    (local i64)
    i64.const 0
    local.set 3
    block ;; label = @1
  ...
  (func (;38;) (type 14) (param i64 i32 i64)
    local.get 0
    local.get 1
    call 33
    local.get 2
  ...
  (func (;77;) (type 24) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;78;) (type 25) (param i32 i64 i64 i64 i64 i32)
